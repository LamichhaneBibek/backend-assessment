...
class Config:
    ...
    POSTS_CACHE_KEY_PREFIX: str = "posts"
    ...
    def get_config() -> Config:
        ...
        redis_url = _get_from_env("REDIS_URL")
        posts_api_url = _get_from_env("POSTS_API_URL")
        cache_expire_in_seconds = int(_get_from_env("CACHE_EXPIRE_IN_SECONDS"))
        posts_cache_key_prefix = _get_from_env("POSTS_CACHE_KEY_PREFIX")



        return Config(db_connection_string, cookies_key_name, session_time, hash_salt, service_host, service_port, postgres_host, postgres_port, postgres_user, postgres_password, db_name, redis_url, posts_api_url,cache_expire_in_seconds, posts_cache_key_prefix )
